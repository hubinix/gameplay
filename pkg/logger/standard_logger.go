...
import (
	"github.com/hubinix/gameplay/pkg/version"
	"os"
	"time"
...
// defaultLogger is the implemention for logrus
...
func newStdLogger(name string) *standardLogger {
...
func (l *standardLogger) EnableJSONOutput(enabled bool) {
...
func (l *standardLogger) SetAppID(id string) {
...
func (l *standardLogger) SetOutputLevel(outputLevel LogLevel) {
	l.logger.Logger.SetLevel(toLogrusLevel(outputLevel))
}

// WithLogType specify the log_type field in log. Default value is LogTypeLog
func (l *standardLogger) WithLogType(logType string) Logger {
